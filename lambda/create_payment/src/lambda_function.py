...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Add optional fields
        optional_fields = [
            'providerPaymentId', 'paymentLinkId', 'paymentLink', 'cancelUrl',
            'successUrl', 'receiveUrl', 'tripId', 'scheduledAt', 'expiresAt',
            'paidAt', 'retryAfterTimestamp', 'callbackUrl'
        ]
        ...
        logger.info(json.dumps({"message": "Payment created", "paymentId": payment_id, "traceId": trace_id}))
